...
- (void)initBaseDataSource{
    _imagesType = [NSArray arrayWithObjects:[UIImage imageNamed:@"水果"],[UIImage imageNamed:@"蔬菜"],[UIImage imageNamed:@"动物"],[UIImage imageNamed:@"生活"],[UIImage imageNamed:@"运动"], nil];
